# Upload a file with [`POST()`](https://httr.r-lib.org/reference/POST.md) or [`PUT()`](https://httr.r-lib.org/reference/PUT.md).

Upload a file with [`POST()`](https://httr.r-lib.org/reference/POST.md)
or [`PUT()`](https://httr.r-lib.org/reference/PUT.md).
