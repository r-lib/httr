...
This outlines how to propose a change to httr. For more detailed info
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("r-lib/httr", fork = TRUE)`.
...
of Conduct](https://httr.r-lib.org/CODE_OF_CONDUCT.md). By contributing
