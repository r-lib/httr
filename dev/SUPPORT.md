...
Thanks for using httr! Before filing an issue, there are a few places to
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/r-lib/httr/issues/new).
...
requests](https://github.com/r-lib/httr/issues) to make sure the bug
