...
[`response()`](https://httr.r-lib.org/dev/reference/response.md) object
...
vector ([`content()`](https://httr.r-lib.org/dev/reference/content.md)),
character vector
([`text_content()`](https://httr.r-lib.org/dev/reference/content.md)),
or parsed into an R object
([`parsed_content()`](https://httr.r-lib.org/dev/reference/content.md)),
...
[`verbose()`](https://httr.r-lib.org/dev/reference/verbose.md), and
...
[`sign_oauth1.0()`](https://httr.r-lib.org/dev/reference/sign_oauth.md)
and
[`sign_oauth2.0()`](https://httr.r-lib.org/dev/reference/sign_oauth.md)
to sign requests. The demos directory has twelve demos of using OAuth:
four for 1.0 (linkedin, twitter, vimeo, and yahoo) and eight for 2.0
(azure, facebook, github, google, linkedin, reddit, yahoo, and yelp).
