...
#> [1] "object-src 'none';base-uri 'self';script-src 'nonce-v53OOOSb9_Hk1ACyL8IaeQ' 'strict-dynamic' 'report-sample' 'unsafe-eval' 'unsafe-inline' https: http:;report-uri https://csp.withgoogle.com/csp/gws/other-hp"
#> 
#> $`reporting-endpoints`
#> [1] "default=\"//www.google.com/httpservice/retry/jserror?ei=VWSLabHACuWYptQPqYfLOQ&cad=crash&error=Page%20Crash&jsel=1\""
#> 
#> $date
#> [1] "Tue, 10 Feb 2026 17:01:09 GMT"
#> 
#> $server
#> [1] "gws"
#> 
...
#> 
#> $`set-cookie`
#> [1] "AEC=AaJma5uhG__3y9MlQ0_DfWlEzxuat0xE0eaDA5SMI0Q0zv3jwIEot2w-uE4; expires=Sun, 09-Aug-2026 17:01:09 GMT; path=/; domain=.google.com; Secure; HttpOnly; SameSite=lax"
#> 
#> $`transfer-encoding`
#> [1] "chunked"
#> 
