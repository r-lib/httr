...
- [`parse_url()`](https://httr.r-lib.org/dev/reference/parse_url.md) now
...
- [`http_status()`](https://httr.r-lib.org/dev/reference/http_status.md)
  now throws the correct error message if http status code is not in the
  list of known codes ([@Javdat](https://github.com/Javdat),
  [\#567](https://github.com/r-lib/httr/issues/567)).

- [`POST()`](https://httr.r-lib.org/dev/reference/POST.md) gains an
  example on how to use `encode = "raw"` for specific json string body
  ([@cderv](https://github.com/cderv),
  [\#563](https://github.com/r-lib/httr/issues/563))

- [`RETRY()`](https://httr.r-lib.org/dev/reference/RETRY.md) now throws
...
- [`VERB()`](https://httr.r-lib.org/dev/reference/VERB.md) and
  [`RETRY()`](https://httr.r-lib.org/dev/reference/RETRY.md) now
...
- [`init_oauth2.0()`](https://httr.r-lib.org/dev/reference/init_oauth2.0.md)
...
- [`cache_info()`](https://httr.r-lib.org/dev/reference/cache_info.md)
  now handles un-named flags, as illustrated by “private” when the
  server returns “private, max-age = 0”.
...
- [`POST()`](https://httr.r-lib.org/dev/reference/POST.md) now uses 22
...
- [`RETRY()`](https://httr.r-lib.org/dev/reference/RETRY.md) now
  terminates on any successful request, regardless of the value of
  `terminate_on`. To return to the previous behaviour, set
  `terminate_on_success = FALSE`
  ([\#522](https://github.com/r-lib/httr/issues/522)).

- In [`RETRY()`](https://httr.r-lib.org/dev/reference/RETRY.md) and
  [`VERB()`](https://httr.r-lib.org/dev/reference/VERB.md), `HEAD`
  requests now succeed
  ([\#478](https://github.com/r-lib/httr/issues/478),
...
- `is_interactive` argument to
  [`init_oauth1.0()`](https://httr.r-lib.org/dev/reference/init_oauth1.0.md),
  [`init_oauth2.0()`](https://httr.r-lib.org/dev/reference/init_oauth2.0.md)
  and
...
- [`RETRY()`](https://httr.r-lib.org/dev/reference/RETRY.md) now retries
...
- [`oauth_app()`](https://httr.r-lib.org/dev/reference/oauth_app.md)
  allows you to specify the `redirect_url` if you need to customise it.
...
- [`oauth_signature()`](https://httr.r-lib.org/dev/reference/oauth_signature.md)
...
- New
  [`oauth2.0_authorize_url()`](https://httr.r-lib.org/dev/reference/init_oauth2.0.md)
  and
  [`oauth2.0_access_token()`](https://httr.r-lib.org/dev/reference/init_oauth2.0.md)
...
- [`DELETE()`](https://httr.r-lib.org/dev/reference/DELETE.md) gains a
  body parameter ([\#326](https://github.com/r-lib/httr/issues/326)).

- New `encode = "raw"` allows you to do your own encoding for requests
  with bodies.

- New [`http_type()`](https://httr.r-lib.org/dev/reference/http_type.md)
...
- Long deprecated `multipart` argument to
  ...
  [`PUT()`](https://httr.r-lib.org/dev/reference/PUT.md) and
  [`PATCH()`](https://httr.r-lib.org/dev/reference/PATCH.md) has been
  removed.
...
- New [`RETRY()`](https://httr.r-lib.org/dev/reference/RETRY.md)
  function allows you to retry a request multiple times until it
  succeeds ([\#353](https://github.com/r-lib/httr/issues/353)).
...
- [`oauth_callback()`](https://httr.r-lib.org/dev/reference/oauth_callback.md)
  gains trailing slash for facebook compatibility
  ([\#324](https://github.com/r-lib/httr/issues/324)).

- [`progress()`](https://httr.r-lib.org/dev/reference/progress.md) gains
...
- [`parse_media()`](https://httr.r-lib.org/dev/reference/parse_media.md)
  can once again parse multiple parameters
...
- [`url_ok()`](https://httr.r-lib.org/dev/reference/http_error.md) and
...
- [`has_content()`](https://httr.r-lib.org/dev/reference/has_content.md)
...
- [`progress()`](https://httr.r-lib.org/dev/reference/progress.md)
  returns `TRUE` to fix for ‘progress callback must return boolean’
  warning ([@jeroenooms](https://github.com/jeroenooms),
...
- [`POST()`](https://httr.r-lib.org/dev/reference/POST.md),
  [`PUT()`](https://httr.r-lib.org/dev/reference/PUT.md) and
  [`PATCH()`](https://httr.r-lib.org/dev/reference/PATCH.md) now drop
  `NULL` body elements. This is convenient and consistent with the
  behaviour for url query params.

### Minor improvements and bug fixes

- `cookies` argument to
  [`handle()`](https://httr.r-lib.org/dev/reference/handle.md) is
...
- [`config()`](https://httr.r-lib.org/dev/reference/config.md) now
  cleans up duplicated options
...
- [`POST()`](https://httr.r-lib.org/dev/reference/POST.md) and
  [`PUT()`](https://httr.r-lib.org/dev/reference/PUT.md) now clean up
  after themselves when uploading a single file
...
- [`VERB()`](https://httr.r-lib.org/dev/reference/VERB.md) gains `body`
  and `encode` arguments so you can generate arbitrary requests with a
  body.
...
- In [`content()`](https://httr.r-lib.org/dev/reference/content.md), if
  no type is provided to function or specified in headers, and we can’t
  guess the type from the extension, we now assume that it’s
  `application/octet-stream`
  ([\#181](https://github.com/r-lib/httr/issues/181)).

- Throw error if
  [`timeout()`](https://httr.r-lib.org/dev/reference/timeout.md) is less
...
- [`VERB()`](https://httr.r-lib.org/dev/reference/VERB.md) allows to you
  use custom http verbs
  ([\#169](https://github.com/r-lib/httr/issues/169)).

- New
  [`handle_reset()`](https://httr.r-lib.org/dev/reference/handle_pool.md)
  to allow you to reset the handle if you get the error “easy handle
...
- [`vignette("api-packages")`](https://httr.r-lib.org/dev/articles/api-packages.md)
...
- Make it again possible to override the content type set up by
  [`POST()`](https://httr.r-lib.org/dev/reference/POST.md) when sending
  data ([\#140](https://github.com/r-lib/httr/issues/140)).
...
- Deprecate
  [`guess_media()`](https://httr.r-lib.org/dev/reference/guess_media.md),
  and instead use
...
- [`POST()`](https://httr.r-lib.org/dev/reference/POST.md) now specifies
...
- [`DELETE()`](https://httr.r-lib.org/dev/reference/DELETE.md) now
  returns body of request
  ([\#138](https://github.com/r-lib/httr/issues/138)).

- [`headers()`](https://httr.r-lib.org/dev/reference/headers.md) is now
  a generic with a method for response objects.
...
- [`url_ok()`](https://httr.r-lib.org/dev/reference/http_error.md) works
...
- New [`headers()`](https://httr.r-lib.org/dev/reference/headers.md) and
  [`cookies()`](https://httr.r-lib.org/dev/reference/cookies.md)
  functions to extract headers and cookies from responses. Previoulsy
  internal
...
- [`POST()`](https://httr.r-lib.org/dev/reference/POST.md),
  [`PUT()`](https://httr.r-lib.org/dev/reference/PUT.md), and
  [`PATCH()`](https://httr.r-lib.org/dev/reference/PATCH.md) now use
...
- [`progress()`](https://httr.r-lib.org/dev/reference/progress.md) will
  display a progress bar, useful if you’re doing large uploads or
  downloads ([\#17](https://github.com/r-lib/httr/issues/17)).

- [`verbose()`](https://httr.r-lib.org/dev/reference/verbose.md) now
  uses a custom debug function so that you can see exactly what data is
  sent to the server. Arguments control exactly what is included, and
  the defaults have been selected to be more helpful for the most common
...
- [`oauth_signature()`](https://httr.r-lib.org/dev/reference/oauth_signature.md)
  and
  [`oauth_header()`](https://httr.r-lib.org/dev/reference/oauth_signature.md)
...
- HTTP verbs ([`GET()`](https://httr.r-lib.org/dev/reference/GET.md),
  [`POST()`](https://httr.r-lib.org/dev/reference/POST.md) etc) now pass
  unnamed arguments to
  [`config()`](https://httr.r-lib.org/dev/reference/config.md) and named
  arguments to
  [`modify_url()`](https://httr.r-lib.org/dev/reference/modify_url.md)
...
- The placement of `...` in
  [`POST()`](https://httr.r-lib.org/dev/reference/POST.md),
  [`PATCH()`](https://httr.r-lib.org/dev/reference/PATCH.md) and
  [`PUT()`](https://httr.r-lib.org/dev/reference/PUT.md) has been
...
- You can suppress the body entirely in
  [`POST()`](https://httr.r-lib.org/dev/reference/POST.md),
  [`PATCH()`](https://httr.r-lib.org/dev/reference/PATCH.md) and
  [`PUT()`](https://httr.r-lib.org/dev/reference/PUT.md) with
  `body = FALSE`.
